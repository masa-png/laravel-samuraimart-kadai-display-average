                            ...
                            <div class="col-12">
                                <p class="samuraimart-product-label mt-2">
                                    ...
                                    <span class="samuraimart-star-rating"
                                        data-rate="{{ round($recommend_product->reviews->avg('score') * 2) / 2 }}"></span>&nbsp;{{ round($recommend_product->reviews->avg('score'), 1) }}<br>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <p class="samuraimart-product-label mt-2">
                                    ...
                                    {{-- レビューの平均評価を表示する --}}
                                    <span class="samuraimart-star-rating"
                                        data-rate="{{ round($recently_product->reviews->avg('score') * 2) / 2 }}"></span>&nbsp;{{ round($recently_product->reviews->avg('score'), 1) }}<br>
